...
const READY_GLAMAI_ITEM: CatalogueItem = {
  ...
  subtitle: "2021 LVMH Innovation Award Finalist",
...
const READY_ALGORAND_ITEM: CatalogueItem = {
  ...
  title: "Leveraging Emotional Engagement to Convert High-Interest Audiences to Users",
  subtitle: "30% Conversion Rate Campaign",
